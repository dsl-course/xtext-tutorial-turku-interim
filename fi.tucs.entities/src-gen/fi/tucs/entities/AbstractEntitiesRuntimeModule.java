...
import fi.tucs.entities.formatting2.EntitiesFormatter;
import fi.tucs.entities.generator.EntitiesGenerator;
import fi.tucs.entities.parser.antlr.EntitiesAntlrTokenFileProvider;
import fi.tucs.entities.parser.antlr.EntitiesParser;
import fi.tucs.entities.parser.antlr.internal.InternalEntitiesLexer;
import fi.tucs.entities.scoping.EntitiesScopeProvider;
import fi.tucs.entities.serializer.EntitiesSemanticSequencer;
import fi.tucs.entities.serializer.EntitiesSyntacticSequencer;
...
public abstract class AbstractEntitiesRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "fi/tucs/entities/Entities.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("fi.tucs.entities.Entities");
	}
